                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            ...
                                            <input type="number"
                                                ...
                                                name="rencana_pelaksanaan_pembelajaran" class="form-control"
                                                id="rencana_pelaksanaan_pembelajaran" placeholder="Input Data......" />
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            ...
                                            <input type="number"
                                                ...
                                                name="kriteria_ketuntasan_minimal" class="form-control"
                                                id="kriteria_ketuntasan_minimal" placeholder="Input Data......" />
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            ...
                                            <input type="number" value="<?= $alternatif['pembuatan_soal'] ?>"
                                                name="pembuatan_soal" class="form-control" id="pembuatan_soal"
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            ...
                                            <input type="number" value="<?= $alternatif['absensi_kehadiran'] ?>"
                                                name="absensi_kehadiran" class="form-control" id="absensi_kehadiran"
                                                placeholder="Input Data......" />
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            ...
                                            <input type="number" value="<?= $alternatif['ketepatan_waktu'] ?>"
                                                name="ketepatan_waktu" class="form-control" id="ketepatan_waktu"
                                                placeholder="Input Data......" />
