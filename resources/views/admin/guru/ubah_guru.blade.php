            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/admin-guru-ubah-data/<?= $guru['id_guru'] ?>" method="POST" id="formInput"
                                autocomplete="off">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group @error('lahir') has-error has-feedback @enderror">
                                            ...
                                            <input type="date" value="<?= $guru['lahir'] ?>" name="lahir"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group @error('telepon') has-error has-feedback @enderror">
                                            ...
                                            <input type="text" value="<?= $guru['telepon'] ?>" name="telepon"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group @error('email') has-error has-feedback @enderror">
                                            ...
                                            <input type="email" value="<?= $guru['email'] ?>" name="email"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group @error('alamat') has-error has-feedback @enderror">
                                            ...
                                            <textarea class="form-control" placeholder="Input Data......" id="alamat" value="<?= $guru['alamat'] ?>"
                                                name="alamat" rows="5"><?= $guru['alamat'] ?></textarea>
                                            <small id="alamat"
